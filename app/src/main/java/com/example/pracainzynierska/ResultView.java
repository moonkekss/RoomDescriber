...
public class ResultView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Result result : mResults) {
            ...
            canvas.drawText(String.format("%s %.2f", Utilities.mClasses[result.classIndex], result.score), result.rect.left + TEXT_X, result.rect.top + TEXT_Y, mPaintText);
            text = Utilities.mClasses[result.classIndex];
        }
    }
